# DataTables para principiantes: Tablas dinámicas | Instalación, Bootstrap, idiomas, controles

Aprende a instalar, configurar, usar y modificar la librería DataTables.js para crear tablas dinámicas, con capacidades superior a una tabla HTML común: conoce cómo utilizar el plugin DataTable en tus proyectos y crear tablas dinámicas asombrosas.
